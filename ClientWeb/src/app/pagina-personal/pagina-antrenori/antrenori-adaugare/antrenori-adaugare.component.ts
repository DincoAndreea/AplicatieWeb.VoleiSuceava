...
@Component({
  selector: 'app-antrenori-adaugare',
  templateUrl: './antrenori-adaugare.component.html',
  styleUrls: ['./antrenori-adaugare.component.css']
})
export class AntrenoriAdaugareComponent implements OnInit, OnDestroy {
  ...
  Adauga(imagine1: string, nume1: string, prenume1: string, nationalitate1: string, dataN1: string, inaltime1: number, post1: string, descriere1: string, event: any){
    ...
    {
      this.getAntrenori.addAntrenor(this.jucatorUpdate).subscribe();
