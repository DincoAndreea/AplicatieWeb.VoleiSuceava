...
@Component({
  selector: 'app-personal-administrare',
  templateUrl: './personal-administrare.component.html',
  styleUrls: ['./personal-administrare.component.css']
})
export class PersonalAdministrareComponent implements OnInit, OnDestroy {
  antrenori: IAntrenor[] = [];
  jucatori: IJucator[] = [];
  ...
  afisareAntrenori():void {
    ...
    document.getElementById("btn-seniori")?.style.setProperty('color', 'white');
    this.PAntrenori(); 
    this.afisPag1=true;
    this.afisPag2=true;  
    this.afisPag3=false;
  ...
  afisareSeniori():void {
    ...
    this.afisareAnt = false;
    this.afisareEch = false;
    this.afisareSen = true;
    document.getElementById("btn-seniori")?.style.setProperty('color', '#0D1760');
    document.getElementById("btn-antrenori")?.style.setProperty('color', 'white');
    document.getElementById("btn-jucatori")?.style.setProperty('color', 'white');
    document.getElementById("btn-echipe")?.style.setProperty('color', 'white');
    //this.PJucatori();
